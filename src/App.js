...
const APIkey = "ed110563855625483c92d9b0f3bc7484";
...
const App = () => {
  ...
  return (
    <div className="w-full h-screen bg-gradientBg bg-no-repeat bg-cover bg-center flex flex-col items-center justify-center px-4 lg:px-0">
      {errorMsg && (
        <div className="w-full max-w-[90vw] lg:max-w-[450px] bg-[#ff208c] text-white absolute top-2 lg:top-10 p-4 captalize rounded-md">{`${errorMsg.response.data.message}`}</div>
      )}
      {/* Form */}
      <form
        className={`${
